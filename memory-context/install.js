#!/usr/bin/env node
// ─────────────────────────────────────────────────────────────
// install.js  —  Install/uninstall memory-context hook
// ─────────────────────────────────────────────────────────────
//
//  Usage:
...
const HOOK_FILES = ['memory-context.js'];
    ...
    hookEntries: [
      {
        ...
        entry: {
          hooks: [{
            type: 'command',
            command: 'node ~/.claude/hooks/memory-context.js',
            timeout: 10,
          }],
        },
      },
...
function install() {
  console.log('');
  console.log('memory-context -- installing');
...
function uninstall() {
  console.log('');
  console.log('memory-context -- uninstalling');
  console.log('-'.repeat(40));
